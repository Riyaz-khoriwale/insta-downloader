...
const PremiumPitch: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mt-16 p-8 bg-gradient-to-br from-gray-800 to-gray-900 border border-violet-500/30 rounded-2xl shadow-2xl">
      <div className="text-center">
        ...
        <p className="text-gray-400 mb-8">Get the ultimate downloading experience with our premium features.</p>
      </div>
